            ...
            getCaret: function () {
                try {
                    var q,
                        ...
                        c = e.selectionStart;
                    if (f && -1 === navigator.appVersion.indexOf("MSIE 10")) (q = f.createRange()), q.moveStart("character", a.is("input") ? -a.val().length : -a.text().length), (b = q.text.length);
                    else if (c || "0" === c) b = c;
                    return b;
                } catch (d) {}
            },
            ...
            getRegexMask: function () {
                for (var a = [], b, e, f, d, h = 0; h < c.length; h++)
                    (b = g.translation[c.charAt(h)])
                        ? ((e = b.pattern.toString().replace(/.{1}$|^.{1}/g, "")), (f = b.optional), (b = b.recursive) ? (a.push(c.charAt(h)), (d = { digit: c.charAt(h), pattern: e })) : a.push(f || b ? e + "?" : e))
